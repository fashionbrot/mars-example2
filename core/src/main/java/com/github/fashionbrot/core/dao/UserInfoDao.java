...
import com.github.fashionbrot.core.mapper.RoleInfoMapper;
import com.github.fashionbrot.core.mapper.UserInfoMapper;
...
public class UserInfoDao  {
    ...
    public LoginModel getLogin() {
        String  authValue  = CookieUtil.getCookieValue(request, GlobalConst.AUTH_KEY,false);
